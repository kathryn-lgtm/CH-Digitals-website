...
export const testimonials = [
  ...
  {
    quote:
      "I attended an in-person seminar run by the amazing Kathryn from OMS Business. The entire event was very well organised, the information incredibly well presented and easy to understand, and the whole thing was enjoyable and engaging. Would thoroughly recommend, thank you.",
    author: "Jemma Ryan",
    company: "",
  },
];
...
export const clientLogos = [
  ...
  { name: "The Birth Teacher", src: "/images/clients/birth-teacher.png" },
  { name: "HydroTek Leak Solutions", src: "/images/clients/hydrotek.png" },
  { name: "Dusk on the Downs", src: "/images/clients/dusk.png" },
  { name: "DMT Ag.", src: "/images/clients/dtmag.png" },
  { name: "JMAG Industries", src: "/images/clients/jmag.png" },
  { name: "Vulcan Tilt Haulage", src: "/images/clients/vulcan.jpg" },
  { name: "Mini Treasure Kids", src: "/images/clients/mtk.png" },
  { name: "MNM Designs", src: "/images/clients/mnm.png" },
  { name: "M & S Sheds", src: "/images/clients/mssheds.png" },
  { name: "The Social Hub Media Group", src: "/images/clients/social-hub.png" },
];
