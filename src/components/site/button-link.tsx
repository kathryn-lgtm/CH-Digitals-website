...
const variants = {
  ...
  // For use on dark backgrounds — visible by default, no className override required.
  "secondary-dark":
    "border border-white/30 text-white hover:border-[var(--color-gold)] hover:text-[var(--color-gold)]",
