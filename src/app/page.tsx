            ...
            <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-1">
              {testimonials.map((testimonial, index) =>
                ...
                <Link
                  ...
                  className={`rounded-[28px] border p-7 transition ${
                    index === 0
                      ? "border-[rgba(200,169,110,0.3)] bg-white shadow-[0_18px_45px_rgba(10,10,10,0.07)]"
                      : "border-[rgba(10,10,10,0.08)] bg-[rgba(255,255,255,0.72)] backdrop-blur-sm"
                  } hover:-translate-y-0.5 hover:border-[var(--color-gold)] hover:shadow-[0_20px_50px_rgba(10,10,10,0.1)]`}
                >
                  <p className="text-lg leading-8 text-[var(--color-copy)]">&ldquo;{testimonial.quote}&rdquo;</p>
            ...
            <div className="space-y-5">
              <div className="rounded-[30px] border border-[rgba(10,10,10,0.08)] bg-[rgba(255,255,255,0.62)] p-6 shadow-[0_18px_45px_rgba(10,10,10,0.05)] backdrop-blur-sm md:p-8">
                <div className="flex items-end justify-between gap-4">
                  ...
                  <span className="hidden rounded-full border border-[rgba(200,169,110,0.28)] bg-[var(--color-cream)] px-4 py-2 text-[10px] font-semibold uppercase tracking-[0.22em] text-[var(--color-meta)] md:inline-flex">
                    Links can be added next
                  </span>
                </div>
                <p className="mt-4 max-w-2xl text-base leading-8 text-[var(--color-copy)]">
                  The visual proof matters now. The remaining outbound client links can be added later once you have each URL confirmed.
                </p>
              </div>
